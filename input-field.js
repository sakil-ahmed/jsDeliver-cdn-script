...
.number-input-dropdown ol li .country-name {
    ...
    const selectBox = $('.number-input-dropdown'),
        searchBox = $('.number-input-search-field'),
        inputBox = $('.number-input-field'),
    ...
    selectBox.append(`<span class="iconify" data-icon="flag:${countries[0].code.toLowerCase()}-4x3"></span>`)
    ...
    selectedOption.appendChild(flagIcon)
